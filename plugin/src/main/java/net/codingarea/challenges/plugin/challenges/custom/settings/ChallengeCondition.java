...
import net.codingarea.challenges.plugin.challenges.custom.settings.action.IChallengeActionLegacy;
...
//	})),
	...
	private final Class<? extends IChallengeActionLegacy> actionClassTarget; // NOT IMPLEMENTED

	ChallengeCondition(Material material, String messageSuffix, IChallengeCondition condition, Class<? extends IChallengeActionLegacy> actionClassTarget, SubSettingsBuilder subSettingsBuilder) {
	...
	ChallengeCondition(Material material, String messageSuffix, IChallengeCondition condition, Class<? extends IChallengeActionLegacy> actionClassTarget, Supplier<SubSettingsBuilder> builderSupplier) {
		this(material, messageSuffix, condition, actionClassTarget, builderSupplier.get());
	}

	ChallengeCondition(Material material, String messageSuffix, IChallengeCondition condition, Class<? extends IChallengeActionLegacy> actionClassTarget) {
	...
	ChallengeCondition(Material material, String messageSuffix, IChallengeCondition condition, SubSettingsBuilder subSettingsBuilder) {
		this(material, messageSuffix, condition, IChallengeActionLegacy.class, subSettingsBuilder);
	}
	...
	public Class<? extends IChallengeActionLegacy> getActionClassTarget() {
