...
public enum ItemTranslation {
	...
	DAMAGE_INVENTORY_CLEAR(a("§cDamage Inventory Clear"), b(a("If a player takes *damage* the *inventories*", "of *all players* will be cleared"), a("Wenn ein Spieler *Schaden* erleided, wird das", "*Inventar* von *allen Spielern* geleert"))),
